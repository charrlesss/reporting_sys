Public Class frmScheduleAccount
    ...
    Private Sub ReportTitle()
        Select Case cmbReport.Text
            Case "GL Account (Detailed)"
                txtReportTitle.Text = frmMain.ReportTitleByDepartment & IIf(txtSubsi.Text.Trim = "" Or txtSubsi.Text.Trim = "ALL", "", "(" & txtSubsi.Text.Trim & ")") & vbCrLf & _
    ...
    Private Sub LoadAccounts()
        frmMain.GetReportTableApi("/reports/accounting/chart-schedule-account-account-desk", AddressOf Account)
    End Sub
    ...
    Private Sub frmScheduleAccount_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If frmMain.FieldStorage.ContainsKey("schedule_account_cmbReport") And
            frmMain.FieldStorage.ContainsKey("schedule_account_cmbSubsi") And
            frmMain.FieldStorage.ContainsKey("schedule_account_cmbInsurance") And
            frmMain.FieldStorage.ContainsKey("schedule_account_cmbSort") And
            frmMain.FieldStorage.ContainsKey("schedule_account_cmbOrder") And
            frmMain.FieldStorage.ContainsKey("schedule_account_dtDate") And
            frmMain.FieldStorage.ContainsKey("schedule_account_txtAccount") And
            frmMain.FieldStorage.ContainsKey("schedule_account_txtAccountName") Then

            cmbReport.SelectedIndex = frmMain.FieldStorage("schedule_account_cmbReport")
            LoadSubsidiary()
            cmbSubsi.SelectedIndex = frmMain.FieldStorage("schedule_account_cmbSubsi")
            cmbInsurance.SelectedIndex = frmMain.FieldStorage("schedule_account_cmbInsurance")
            cmbSort.SelectedIndex = frmMain.FieldStorage("schedule_account_cmbSort")
            cmbOrder.SelectedIndex = frmMain.FieldStorage("schedule_account_cmbOrder")
            dtDate.Value = frmMain.FieldStorage("schedule_account_dtDate")
    ...
    Private Async Sub btnSchecSubmit_Click(sender As Object, e As EventArgs) Handles btnSchecSubmit.Click
        ...
        frmMain.PostReportApi("/reports/accounting/schedule-account-report-desk", postData, AddressOf HandleApiResponse)
    End Sub
    ...
    Sub StoredFields()
        frmMain.FieldStorage("schedule_account_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("schedule_account_cmbSubsi") = cmbSubsi.SelectedIndex
        frmMain.FieldStorage("schedule_account_cmbInsurance") = cmbInsurance.SelectedIndex
        frmMain.FieldStorage("schedule_account_cmbSort") = cmbSort.SelectedIndex
        frmMain.FieldStorage("schedule_account_cmbOrder") = cmbOrder.SelectedIndex
        frmMain.FieldStorage("schedule_account_dtDate") = dtDate.Value
        frmMain.FieldStorage("schedule_account_txtAccount") = txtAccount.Text
        frmMain.FieldStorage("schedule_account_txtAccountName") = txtAccountName.Text
