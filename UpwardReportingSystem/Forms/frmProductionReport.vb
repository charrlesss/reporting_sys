Public Class frmProductionReport
    ...
    Private Sub ReportTitle()
        txtReportTitle.Text = frmMain.ReportTitleByDepartment & IIf(sReport = "Production Report", IIf(cmbType.SelectedIndex = 0, "", "(Financed)"), IIf(cmbSubAcct.Text = "ALL", "", "(" & cmbSubAcct.Text & ")")) & vbCrLf & _
    ...
    Private Sub LoadType()
        frmMain.GetReportTableApi("/reports/accounting/get-report-policy-types", AddressOf getTypes)
    ...
    Private Sub ProductionReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If frmMain.FieldStorage.ContainsKey("production_report_cmbFormat") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbType") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbReport") And
            frmMain.FieldStorage.ContainsKey("production_report_numYear") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbSubAcct") And
            frmMain.FieldStorage.ContainsKey("production_report_dtDate") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbpolicy") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbSort") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbOrder") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbFormat") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbType") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbReport") And
            frmMain.FieldStorage.ContainsKey("production_report_numYear") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbSubAcct") And
            ...
            frmMain.FieldStorage.ContainsKey("production_report_cmbpolicy") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbSort") And
            frmMain.FieldStorage.ContainsKey("production_report_cmbOrder") Then

            cmbFormat.SelectedIndex = frmMain.FieldStorage("production_report_cmbFormat")
            cmbType.SelectedIndex = frmMain.FieldStorage("production_report_cmbType")
            cmbReport.SelectedIndex = frmMain.FieldStorage("production_report_cmbReport")
            numYear.Value = frmMain.FieldStorage("production_report_numYear")
            cmbSubAcct.SelectedIndex = frmMain.FieldStorage("production_report_cmbSubAcct")
            dtDate.Value = frmMain.FieldStorage("production_report_dtDate")
            cmbpolicy.SelectedIndex = frmMain.FieldStorage("production_report_cmbpolicy")
            cmbSort.SelectedIndex = frmMain.FieldStorage("production_report_cmbSort")
            cmbOrder.SelectedIndex = frmMain.FieldStorage("production_report_cmbOrder")
        Else
    ...
    Private Async Sub btnSchecSubmit_Click(sender As Object, e As EventArgs) Handles btnSchecSubmit.Click
        ...
        frmMain.PostReportApi("/reports/reports/get-production-report-desk", postData, AddressOf HandleApiResponse)
    End Sub
    ...
    Sub StoredFields()
        frmMain.FieldStorage("production_report_cmbFormat") = cmbFormat.SelectedIndex
        frmMain.FieldStorage("production_report_cmbType") = cmbType.SelectedIndex
        frmMain.FieldStorage("production_report_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("production_report_numYear") = numYear.Value
        frmMain.FieldStorage("production_report_cmbSubAcct") = cmbSubAcct.SelectedIndex
        frmMain.FieldStorage("production_report_dtDate") = dtDate.Value
        frmMain.FieldStorage("production_report_cmbpolicy") = cmbpolicy.SelectedIndex
        frmMain.FieldStorage("production_report_cmbSort") = cmbSort.SelectedIndex
        frmMain.FieldStorage("production_report_cmbOrder") = cmbOrder.SelectedIndex
    End Sub
End Class