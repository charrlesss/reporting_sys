Public Class frmGeneralJournalBook
    Dim dt As DataTable
    Public sReport As String = "General Journal Book"

    Private Sub ReportTitle()
        txtReportTitle.Text = frmMain.ReportTitleByDepartment & IIf(cmbSubAcct.Text = "ALL", "", "(" & cmbSubAcct.Text & ")") & vbCrLf &
    ...
    End Sub
    Private Sub frmGeneralJournalBook_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If frmMain.FieldStorage.ContainsKey("general_journal_cmbFormat") And
        frmMain.FieldStorage.ContainsKey("general_journal_cmbReport") And
        frmMain.FieldStorage.ContainsKey("general_journal_cmbSubAcct") And
        frmMain.FieldStorage.ContainsKey("general_journal_dtDate") And
        frmMain.FieldStorage.ContainsKey("general_journal_cmbOrder") And
        frmMain.FieldStorage.ContainsKey("general_journal_cmbSort") Then

            cmbFormat.SelectedIndex = frmMain.FieldStorage("general_journal_cmbFormat")
            cmbReport.SelectedIndex = frmMain.FieldStorage("general_journal_cmbReport")
            cmbSubAcct.SelectedIndex = frmMain.FieldStorage("general_journal_cmbSubAcct")
            dtDate.Value = frmMain.FieldStorage("general_journal_dtDate")
            cmbOrder.SelectedIndex = frmMain.FieldStorage("general_journal_cmbOrder")
            cmbSort.SelectedIndex = frmMain.FieldStorage("general_journal_cmbSort")
        Else
    ...
    Private Async Sub btnSchecSubmit_Click(sender As Object, e As EventArgs) Handles btnSchecSubmit.Click
        ...
        frmMain.PostReportWithSummaryApi("/reports/accounting/general-journal-book-gjb-desk", postData, AddressOf HandleApiResponse)
    End Sub
    ...
    Sub StoredFields()
        ...
        frmMain.FieldStorage("general_journal_cmbFormat") = cmbFormat.SelectedIndex
        frmMain.FieldStorage("general_journal_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("general_journal_cmbSubAcct") = cmbSubAcct.SelectedIndex
        frmMain.FieldStorage("general_journal_dtDate") = dtDate.Value
        frmMain.FieldStorage("general_journal_cmbOrder") = cmbOrder.SelectedIndex
        frmMain.FieldStorage("general_journal_cmbSort") = cmbSort.SelectedIndex
    End Sub
End Class