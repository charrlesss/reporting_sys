Public Class frmModal
    ...
    Private Sub Modal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf frmMain.ACCESS = "PRODUCTION_ACCOUNTING" Then
            buttonNames = {
        ...
        ElseIf frmMain.ACCESS = "PRODUCTION" Then
            buttonNames = {
                  "Production Report",
                  "Renewal Notice"
              }
        ElseIf frmMain.ACCESS = "ACCOUNTING" Then
            buttonNames = {
                  "Schedule of Accounts",
                  "Subsidiary Ledger",
                  "Trial Balance",
        ...
        If frmMain.FieldStorage.ContainsKey("form_title") Then
            SetSelectedForm(frmMain.FieldStorage("form_title"))
    ...
    Private Sub Button_Click(sender As Object, e As EventArgs)
        ...
        frmMain.FieldStorage("form_title") = Array.IndexOf(buttonNames, buttonText)
