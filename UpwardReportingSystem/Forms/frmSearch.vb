    ...
    Private Sub LoadSearch(ByVal SearchFor As String, Optional ByVal Search As String = "")
        ...
        Select Case SearchFor
            Case "Chart of Account"
                frmMain.GetReportTableApi("/reports/accounting/chart-schedule-account-desk?account_search=" & Search & ExtraURLParams, AddressOf ChartAccount)
            Case "Policy"
                frmMain.GetReportTableApi("/task/claims/claims/get-policy-desk?searchPolicy=" & Search & ExtraURLParams, AddressOf PolicyAccount)
        End Select
