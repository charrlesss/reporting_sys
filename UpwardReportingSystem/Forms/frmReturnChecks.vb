Public Class frmReturnChecks
    ...
    Private Sub frmAbstractCollection_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadControls()
        If frmMain.FieldStorage.ContainsKey("return_checks_cmbFormat") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbReport") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbSubAcct") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbReport") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbpolicy") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbSort") And
            frmMain.FieldStorage.ContainsKey("return_checks_cmbOrder") And
            frmMain.FieldStorage.ContainsKey("return_checks_dtDate") Then
            cmbFormat.SelectedIndex = frmMain.FieldStorage("return_checks_cmbFormat")
            cmbReport.SelectedIndex = frmMain.FieldStorage("return_checks_cmbReport")
            cmbSubAcct.SelectedIndex = frmMain.FieldStorage("return_checks_cmbSubAcct")
            cmbReport.SelectedIndex = frmMain.FieldStorage("return_checks_cmbReport")
            cmbpolicy.SelectedIndex = frmMain.FieldStorage("return_checks_cmbpolicy")
            cmbSort.SelectedIndex = frmMain.FieldStorage("return_checks_cmbSort")
            cmbOrder.SelectedIndex = frmMain.FieldStorage("return_checks_cmbOrder")
            dtDate.Value = frmMain.FieldStorage("return_checks_dtDate")
        Else
    ...
    Private Async Sub btnSchecSubmit_Click(sender As Object, e As EventArgs) Handles btnSchecSubmit.Click
        ...
        frmMain.PostReportWithSummaryApi("/reports/accounting/return-checks-collection-desk", postData, AddressOf HandleApiResponse)
    End Sub
    ...
    Sub StoredFields()
        ...
        frmMain.FieldStorage("return_checks_cmbFormat") = cmbFormat.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbSubAcct") = cmbSubAcct.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbpolicy") = cmbpolicy.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbSort") = cmbSort.SelectedIndex
        frmMain.FieldStorage("return_checks_cmbOrder") = cmbOrder.SelectedIndex
        frmMain.FieldStorage("return_checks_dtDate") = dtDate.Value
    End Sub
