Public Class frmClaims
    ...
    Private Sub frmClaims_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If frmMain.FieldStorage.ContainsKey("claims_cmbFormat") And
         frmMain.FieldStorage.ContainsKey("claims_txtPolicyNo") And
         frmMain.FieldStorage.ContainsKey("claims_txtAssuredName") And
         frmMain.FieldStorage.ContainsKey("claims_dtDateFrom") And
         frmMain.FieldStorage.ContainsKey("claims_dtDateTo") And
         frmMain.FieldStorage.ContainsKey("claims_cmbStatus") And
         frmMain.FieldStorage.ContainsKey("claims_cmbReport") And
         frmMain.FieldStorage.ContainsKey("claims_cmbClaimType") Then

            cmbFormat.SelectedIndex = frmMain.FieldStorage("claims_cmbFormat")
            txtPolicyNo.Text = frmMain.FieldStorage("claims_txtPolicyNo")
            txtAssuredName.Text = frmMain.FieldStorage("claims_txtAssuredName")
            dtDateFrom.Value = frmMain.FieldStorage("claims_dtDateFrom")
            dtDateTo.Value = frmMain.FieldStorage("claims_dtDateTo")
            cmbStatus.SelectedIndex = frmMain.FieldStorage("claims_cmbStatus")
            cmbReport.SelectedIndex = frmMain.FieldStorage("claims_cmbReport")
            cmbClaimType.SelectedIndex = frmMain.FieldStorage("claims_cmbClaimType")
        Else
    ...
    Private Async Sub btnSchecSubmit_Click(sender As Object, e As EventArgs) Handles btnSchecSubmit.Click
        ...
        frmMain.PostReportApi("/task/claims/claims/report-claim-desk", postData, AddressOf HandleApiResponse)
    End Sub
    ...
    Sub StoredFields()
        frmMain.FieldStorage("claims_cmbFormat") = cmbFormat.SelectedIndex
        frmMain.FieldStorage("claims_txtPolicyNo") = txtPolicyNo.Text
        frmMain.FieldStorage("claims_txtAssuredName") = txtAssuredName.Text
        frmMain.FieldStorage("claims_dtDateFrom") = dtDateFrom.Value
        frmMain.FieldStorage("claims_dtDateTo") = dtDateTo.Value
        frmMain.FieldStorage("claims_cmbStatus") = cmbStatus.SelectedIndex
        frmMain.FieldStorage("claims_cmbReport") = cmbReport.SelectedIndex
        frmMain.FieldStorage("claims_cmbClaimType") = cmbClaimType.SelectedIndex
    End Sub
