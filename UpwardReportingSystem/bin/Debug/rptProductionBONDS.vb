...
Public Class rptProductionBONDS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptProductionBONDS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionBONDS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionBONDS = New rptProductionBONDS()
        rpt.Site = Me.Site
        Return rpt
    End Function
