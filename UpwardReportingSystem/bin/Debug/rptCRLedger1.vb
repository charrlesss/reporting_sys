...
Public Class rptCRLedger1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptCRLedger1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCRLedger1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCRLedger1 = New rptCRLedger1()
        rpt.Site = Me.Site
        Return rpt
    End Function
