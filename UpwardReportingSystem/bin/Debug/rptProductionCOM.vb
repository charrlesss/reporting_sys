...
Public Class rptProductionCOM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptProductionCOM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionCOM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionCOM = New rptProductionCOM()
        rpt.Site = Me.Site
        Return rpt
    End Function
