...
Public Class rptClaimsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptClaimsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClaimsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimsReport = New rptClaimsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
