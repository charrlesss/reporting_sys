...
Public Class rptProductionTPL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptProductionTPL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionTPL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionTPL = New rptProductionTPL()
        rpt.Site = Me.Site
        Return rpt
    End Function
