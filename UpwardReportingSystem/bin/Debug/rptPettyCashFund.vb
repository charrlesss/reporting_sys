...
Public Class rptPettyCashFund
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptPettyCashFund.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPettyCashFund
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPettyCashFund = New rptPettyCashFund()
        rpt.Site = Me.Site
        Return rpt
    End Function
