...
Public Class rptRenewalNotice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptRenewalNotice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRenewalNotice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRenewalNotice = New rptRenewalNotice()
        rpt.Site = Me.Site
        Return rpt
    End Function
