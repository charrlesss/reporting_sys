...
Public Class rptRenewalNoticePA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptRenewalNoticePA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRenewalNoticePA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRenewalNoticePA = New rptRenewalNoticePA()
        rpt.Site = Me.Site
        Return rpt
    End Function
