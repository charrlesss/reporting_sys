...
Public Class rptCRLedger2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptCRLedger2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCRLedger2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCRLedger2 = New rptCRLedger2()
        rpt.Site = Me.Site
        Return rpt
    End Function
