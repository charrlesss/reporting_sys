...
Public Class rptReturnedChecks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptReturnedChecks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReturnedChecks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReturnedChecks = New rptReturnedChecks()
        rpt.Site = Me.Site
        Return rpt
    End Function
