...
Public Class rptBookFormat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptBookFormat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookFormat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookFormat = New rptBookFormat()
        rpt.Site = Me.Site
        Return rpt
    End Function
