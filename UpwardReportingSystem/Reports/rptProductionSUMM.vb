...
Public Class rptProductionSUMM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptProductionSUMM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionSUMM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionSUMM = New rptProductionSUMM()
        rpt.Site = Me.Site
        Return rpt
    End Function
