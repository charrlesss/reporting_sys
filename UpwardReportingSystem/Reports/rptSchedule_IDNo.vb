...
Public Class rptSchedule_IDNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptSchedule_IDNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSchedule_IDNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSchedule_IDNo = New rptSchedule_IDNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
