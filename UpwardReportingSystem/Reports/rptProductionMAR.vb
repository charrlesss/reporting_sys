...
Public Class rptProductionMAR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptProductionMAR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionMAR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionMAR = New rptProductionMAR()
        rpt.Site = Me.Site
        Return rpt
    End Function
