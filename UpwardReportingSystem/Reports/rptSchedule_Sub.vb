...
Public Class rptSchedule_Sub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptSchedule_Sub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSchedule_Sub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSchedule_Sub = New rptSchedule_Sub()
        rpt.Site = Me.Site
        Return rpt
    End Function
