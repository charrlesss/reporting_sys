...
Public Class rptSchedule_Cont1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UpwardReportingSystem.rptSchedule_Cont1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSchedule_Cont1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSchedule_Cont1 = New rptSchedule_Cont1()
        rpt.Site = Me.Site
        Return rpt
    End Function
